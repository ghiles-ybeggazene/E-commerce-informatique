		...
		<div class="panel panel-default">
			<div class="panel-heading "> 
				<h1 class="titre" style="font-weight:bold;color:red">
					VOICI LE FORMULAIRE D'AJOUT DES PRODUITS !!!
				</h1>
			</div>
			<div class="panel-body"style="background-color:black;">
				<form id="formulaire" class="form-horizontal"style="margin-top:30px" method="post" action="control_ajout_produit.php">
					<div class="col-xs-12">
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input type="text"  required class="form-control" id="ref" placeholder="la reference du produit ex : s2009" name="ref"  patern="[a-zA-Z0-9]"data-toggle="tooltip" data-placement="left" title="Tooltip on left">
							</div>
							<div class="col-xs-6"> 
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							<div class="col-xs-4">
								...
								?>
								<option class="form-control" id="categorie" value="<?php echo ($donnee['nom_categorie']); ?>" placeholder="la categorie du produit ex : laptop" required data-toggle="tooltip" data-placement="left" title="Tooltip on left">
									<?php
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input type="number" class="form-control" min="0" id="prix" placeholder="le prix du produit ex : 25000" name="prix" required patern="[0-9]+" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
							</div>
							<div class="col-xs-6"> 
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							<div class="col-xs-4">
								<textarea class="form-control" id="information" placeholder="les informations suplementaires sur ce produit " name="information" "data-toggle="tooltip" data-placement="left" title="Tooltip on left"></textarea>
							</div>
							<div class="col-xs-6"> 
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input type="number" class="form-control" min="1" id="quantite" placeholder="definir la quantite du produit ex : 10" name="quantite" required patern="[a-zA-Z0-9]"data-toggle="tooltip" data-placement="left" title="Tooltip on left">
							</div>
							<div class="col-xs-6"> 
...
function verifier()
{
	...
	err_ref.innerHTML="";
	err_categorie.innerHTML="";
	err_image.innerHTML="";
	err_information.innerHTML="";
	err_qte.innerHTML="";
	err_prix.innerHTML="";
...
if (isset($_SESSION['erreur_prod_existe'])) 
{
	echo("<script>alert('ce produit existe deja!!!');</script>");
	unset($_SESSION['erreur_prod_existe']);
}

if (isset($_SESSION['erreur_prod_prix'])) {
	echo "<script>alert('le prix du produit n\'est pas compatible !!!');</script>";
	unset($_SESSION['erreur_prod_prix']);
}


if (isset($_SESSION['erreur_prod_qte'])) {
	echo "<script>alert('la quantité du produit n\'est pas compatible !!!');</script>";
	unset($_SESSION['erreur_prod_qte']);
}


if (isset($_SESSION['erreur_prod_remplir'])) {
	echo("<script>alert('veuillez renseignez tous les champs!!!');</script>");
	unset($_SESSION['erreur_prod_remplir']);
}
