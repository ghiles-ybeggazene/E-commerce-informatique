...
<div class="panel panel-default ">
 ...
 <form class="form-inline text-center"autofocus method="post" action="inscription.php">
  <div class="form-group ">
    ...
    <input type="text" class="form-control t" id="exampleInputName2" value="" ="Jane Doe"name="loginn"required>
  </div>
  <div class="form-group ">
    <label for="exampleInputEmail2">Mot de passe : </label>
    <input type="password" class="form-control t" id="exampleInputEmail2" value="" ="jane.doe@example.com"name="pass1"required>
  </div>
...
<div class="col-xs-6">
  ...
  <label class="control-label col-sm-5" for="inputError2">Confirmer mot de passe</label>
  <div class="col-sm-7">
  <input type="password" class="form-control focus" id="inputError2" aria-describedby="inputError2Status" name="pass2"autofocus>
  <span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
  <span id="inputError2Status" style="color:red;">Mot de passe erroné</span>
</div></div>
  </div>
