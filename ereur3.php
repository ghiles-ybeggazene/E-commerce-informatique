...
<div class="col-xs-6">
  ...
  <div class="col-sm-7">
  <input type="text" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="loginn" placeholder="votre login" required>
  <span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
  <span id="inputError2Status" style="color:red;">Veullez insérer entre 8 et 20 caractéres</span>
</div></div>
  </div>
