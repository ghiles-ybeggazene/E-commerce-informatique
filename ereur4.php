...
<div class="col-xs-6">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-7">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Confirmation" name="pass2"required>
    </div>
  </div></div>
  ...
  <div class="col-sm-7">
  <input type="date" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="agee"autofocus patern="[a-za-z]">
