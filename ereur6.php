...
<div class="col-xs-6"><div class="form-group has-error has-feedback">
  <label class="control-label col-sm-5" for="inputError2">Nom:</label>
  <div class="col-sm-7">
  <input type="text" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="nomm" placeholder="votre nom" autofocus patern="[a-za-z]">
  <span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
  <span id="inputError2Status" style="color:red;">Nom invalide!!!</span>
</div></div>
  </div>
  <div class="col-xs-6">
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      <input type="phone" class="form-control" id="inputPassword3" value="<?php echo $_SESSION['adresse'];?>" name="tell"required>
    </div>
  </div></div>
  <div class="col-xs-6">
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Password"name="pass1"required>
    </div>
  </div></div>
  <div class="col-xs-6">
  <div class="form-group">
    ...
    <div class="col-xs-7">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Confirmation mot de passe" name="pass2"required>
    </div>
  </div></div>
  <div class="col-xs-6">
  <div class="form-group">
