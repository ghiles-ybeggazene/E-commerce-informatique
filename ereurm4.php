...
<div class="col-xs-6">
  ...
  <div class="col-xs-6">
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-5 control-label">Mot d'utilisateur : </label>
    <div class="col-sm-7">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Password"name="passold"required>
    </div>
  </div></div>
  <div class="col-xs-6">
  <div class="form-group">
    ...
    <div class="col-xs-7">
      <input type="password" class="form-control" id="inputPassword3" placeholder="votre mot de passe" name="passnew"required>
    </div>
  </div></div>
  <div class="col-xs-6"><div class="form-group has-error has-feedback">
  <label class="control-label col-sm-5" for="inputError2">Date de Naissance:</label>
  <div class="col-sm-7">
  <input type="date" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="agee"autofocus patern="[a-za-z]"placeholder="votre date de naissance">
  <span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
  <span id="inputError2Status" style="color:red;">date de naissance invalide(vous n'avez pas plus de 18ans??)!!!</span>
</div></div>
  </div>
  <div class="col-xs-6">
  <div class="row">
