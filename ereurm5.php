...
<div class="col-xs-6">
  ...
  <div class="col-sm-7">
  <input type="text" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="prenomm"autofocus patern="[a-za-z]"placeholder="votre prenom">
