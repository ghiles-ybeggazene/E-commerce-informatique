...
<div class="col-xs-6"><div class="form-group has-error has-feedback">
  ...
  <div class="col-sm-7">
  <input type="text" class="form-control focus" id="inputError2" aria-describedby="inputError2Status"name="nomm"autofocus patern="[a-za-z]"placeholder="votre nom">
...
<input type="submit" class="btn btn-default btn-danger envoyer bphp" value="VALIDER" name="modifier"></input>
