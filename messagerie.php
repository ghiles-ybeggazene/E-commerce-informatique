...
<div class="container header3  im3  "  >
    ...
    <div class="col-xs-8">
      <ul class="nav navbar-nav">
        ...
        <li >
          <a href="#" ><span class="glyphicon glyphicon-shopping-cart"></span> MON PANIER  </a>
...
include('try.php');
 $affiche=$bdd->query('SELECT * FROM messagerie ORDER BY date_message  ');
 while ($rep=$affiche->fetch()) {
  echo '<div class="row">
  <p>
  <div class="col-xs-2 avatar">
  <p ><span style="color:red"class="place ">'.$_SESSION['nom'].' '.$_SESSION['prenom'].'</br> '.$rep['date_message'].'</span></p>
  </div><div class="col-xs-8 chatline ">
  <div class="alert alert-warning focus"id="lastsms" >'.$rep['message'].'</div>
  </div></div></p></div> ';
...
<div class="container bouton fixe">
<form class="form" action="traitsms.php" method="post">
