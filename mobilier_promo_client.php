...
<head>
<meta charset="UTF-8">
  <title>mobilier promotion</title>
...
FROM (classe INNER JOIN categorie ON classe.id_classe = categorie.id_classe) INNER JOIN produit ON categorie.id_categorie = produit.id_categorie
 WHERE nom_classe="mobilier" AND promotion="oui" ORDER BY nom_categorie');
...
while($donnee = $req -> fetch())
{
  ...
  <div class="col-xs-4 " >
    <div class="thumbnail"style="height:500px;">
      <img  class="img img-thumbnail im" src = "<?php echo $donnee['image']; ?>"style="height:300px;" />
      <div class="caption">
   ...
   echo  '<h4>quantité restante :<span class="badge">'.$_SESSION['quantite'][$donnee['ref_produit']].'</span></h4>';
    ...
    ?>
      ...
      <p class="text-center">
        ...
        <form method="POST"   action="ajout_panier.php?ref=<?php echo $ref; ?>&amp;id=4;">
       <div class="col-xs-10">
